...
public class TestCentro {
	public static void main(String[] args) {
		...
		testGetEspaciosOrdenadosPorCapacidad();
	}
	...
	private static void testMetodoCreacionalCopiaNormal() {
		...
		Centro c = new CentroImpl("Escuela Técnica Superior de Ingeniería", "Av. de Reina Mercedes s/n", 2, 5);
	...
	private static void testGetEspaciosOrdenadosPorCapacidad() {
		...
		etsii.nuevoEspacio(new DespachoImpl("F0.21", 3, 0));
		etsii.nuevoEspacio(new DespachoImpl("F0.22", 2, 0));
		testGetEspaciosOrdenadosPorCapacidad(etsii);
	}
	...
	private static void testGetEspaciosOrdenadosPorCapacidad(Centro c) {
		System.out.println("Los espacios del centro ordenados por capacidad son: " + c.getEspaciosOrdenadosPorCapacidad());
	}
