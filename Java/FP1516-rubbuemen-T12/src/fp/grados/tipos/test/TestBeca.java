...
public class TestBeca {
	public static void main(String[] args) {
		...
		testMetodoCreacionalParametrosNormal1();
	...
	private static void testMetodoCreacionalParametrosNormal1() {
		System.out.println("\n========Probando método creacional por parámetros 1======================================================================================");
		testMetodoCreacionalParametros1("ABC1234", 10000.0, 6, TipoBeca.ORDINARIA);
		//Nota: para hacer saltar la excepción, habría que modificar los datos
	}
	
	private static void testMetodoCreacionalParametrosNormal2() {
		System.out.println("\n========Probando método creacional por parámetros 2======================================================================================");
		testMetodoCreacionalParametros2("ABC1234", TipoBeca.ORDINARIA);
		//Nota: para hacer saltar la excepción, habría que modificar los datos
	}
	...
	private static void testMetodosPoblacionales() {
		...
		System.out.println("Número de becas creadas: " + Grados.getNumBecasCreadas());
		System.out.println("Becas creadas: " + Grados.getBecasCreadas());
		System.out.println("Número de becas creadas para un determinado tipo de beca: " + Grados.getNumBecasTipo(TipoBeca.ORDINARIA));
	}
	...
	private static void testMetodoCreacionalParametros1(String codigo, Double cuantiaTotal, Integer duracion, TipoBeca tipo) {
		try {
			Beca b = Grados.createBeca(codigo, cuantiaTotal, duracion, tipo);
			mostrarBeca(b);
		} catch (ExcepcionBecaNoValida e) {
			System.out.println("Se ha capturado la excepción ExcepcionBecaNoValida: \n\t" + e.getMessage());
		} catch (Exception e) {
	...
	private static void testMetodoCreacionalParametros2(String codigo, TipoBeca tipo) {
		try {
			Beca b = Grados.createBeca(codigo, tipo);
			mostrarBeca(b);
		} catch (ExcepcionBecaNoValida e) {
			System.out.println("Se ha capturado la excepción ExcepcionBecaNoValida: \n\t" + e.getMessage());
		} catch (Exception e) {
	...
	private static void testMetodoCreacionalCopia(Beca b) {
		try {
			Beca res = Grados.createBeca(b);
			mostrarBeca(res);
		} catch (ExcepcionBecaNoValida e) {
			System.out.println("Se ha capturado la excepción ExcepcionBecaNoValida: \n\t" + e.getMessage());
		} catch (Exception e) {
	...
	private static void testMetodoCreacionalString(String b) {
		try {
			Beca res = Grados.createBeca(b);
			mostrarBeca(res);
		} catch (ExcepcionBecaNoValida e) {
	...
	private static void testMetodoCreacionalFichero(String fichero) {
		List<Beca> becas = Grados.createBecas(fichero);
		for (Beca b : becas) {
			mostrarBeca(b);
		}
	}
