...
public class TestGrado {
	public static void main(String[] args) {
		...
		testGetDepartamentosOrdenadosPorAsignaturas();
	}
	...
	private static void testMetodoCreacionalParametrosNormal() {
		...
		asignaturasOptativas.add(ir);
		asignaturasOptativas.add(so);
		testMetodoCreacionalParametros("Ingeniería Informática de Software", asignaturasObligatorias, asignaturasOptativas, 12.0);
	...
	private static void testGetCreditosPorAsignatura() {
		System.out.println("\n========Probando el método getCreditosPorAsignatura======================================================================================");
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Departamento ccia = new DepartamentoImpl("Ciencias de la Computación e Inteligencia Artificial");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 5.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 1, lsi);
		Asignatura adda = new AsignaturaImpl("Analisis y Diseño de Datos y Algoritmos", "2050010", 12.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 1, lsi);
		Asignatura ir = new AsignaturaImpl("Ingeniería de Requisitos", "2050020", 12.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 2, lsi);
		Asignatura so = new AsignaturaImpl("Sistemas Operativos", "2050014", 12.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 2, ccia);
		Set<Asignatura> asignaturasObligatorias = new HashSet<>();
		...
		asignaturasOptativas.add(so);
		Grado g = new GradoImpl("Ingeniería Informática de Software", asignaturasObligatorias, asignaturasOptativas, 12.0);
		testGetCreditosPorAsignatura(g);
	}
	...
	private static void testMetodosPoblacionales() {
		...
		System.out.println("Número de grados creados: " + Grados.getNumGradosCreados());
		System.out.println("Grados creados: " + Grados.getGradosCreados());
		System.out.println("Número medio de asignaturas obligatorias de los grados: " + Grados.getMediaAsignaturasObligatoriasGrados());
		System.out.println("Número medio de asignaturas optativas de los grados: " + Grados.getMediaAsignaturasOptativasGrados());
		System.out.println("Número medio de asignaturas de los grados: " + Grados.getMediaAsignaturasGrados());
	}
	
	private static void testGetDepartamentosOrdenadosPorAsignaturas() {
		...
		asignaturasOptativas.add(so);
		Grado g = new GradoImpl("Ingeniería Informática de Software", asignaturasObligatorias, asignaturasOptativas, 12.0);
		testGetDepartamentosOrdenadosPorAsignaturas(g);
	}
	...
	private static void testMetodoCreacionalParametros(String nombre, Set<Asignatura> asignaturasObligatorias, Set<Asignatura> asignaturasOptativas, Double numeroMinimoCreditosOptativas) {
		try {
			Grados.setUsarJava8(false);
			Grado g = Grados.createGrado(nombre, asignaturasObligatorias, asignaturasOptativas, numeroMinimoCreditosOptativas);
			mostrarGrado(g);
		} catch (ExcepcionGradoNoValido e) {
			System.out.println("Se ha capturado la excepción ExcepcionGradoNoValido: \n\t" + e.getMessage());
		} catch (Exception e) {
	...
	private static void testGetAsignatura(Grado g, String codigo){
		...
		System.out.println("Las asignaturas del grado '" + g + "' cuyo código es " + codigo + " es: " + g.getAsignatura(codigo));
	}
	
	private static void testGetCreditosPorAsignatura(Grado g){
		System.out.println("Las asignaturas obligatorias del grado '" + g + "' son:");
		mostrarAsignaturasObligatoriasGrado(g);
		System.out.println("Las asignaturas optativas del grado '" + g + "' son:");
		mostrarAsignaturasOptativasGrado(g);
		System.out.println("Las asignaturas del grado '" + g + "' con sus respectivos números de créditos es " + g.getCreditosPorAsignatura());
	}
	...
	private static void testGetDepartamentosOrdenadosPorAsignaturas(Grado g) {
		System.out.println("Los departamentos ordenados por el número de asignaturas son: " + g.getDepartamentosOrdenadosPorAsignaturas());
	}
