...
public class TestAlumno {
	public static void main(String[] args) {
		...
		testGetAsignaturasOrdenadasPorCurso();
	}
	...
	private static void testGetAsignaturasOrdenadasPorCurso() {
		System.out.println("\n========Probando método getAsignaturasOrdenadasPorCurso======================================================================================");
		Alumno a = new AlumnoImpl("12345678Z", "Juan", "Nadie Nadie", LocalDate.of(1950, 3, 15), "juan.nadie@alum.us.es");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 2);
		Asignatura adda = new AsignaturaImpl("Analisis y Diseño de Datos y Algoritmos", "2050010", 12.0, TipoAsignatura.ANUAL, 2);
		Asignatura ir = new AsignaturaImpl("Ingeniería de Requisitos", "2050020", 9.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 3);
		a.matriculaAsignatura(fp);
		a.matriculaAsignatura(adda);
		a.matriculaAsignatura(ir);
		testGetAsignaturasOrdenadasPorCurso(a);
	}
	...
	private static void testGetAsignaturasOrdenadasPorCurso(Alumno a) {
		System.out.println("Las asignaturas del alumno " + a.getNombre() + " " + a.getApellidos() + " ordenadas por curso son: " + a.getAsignaturasOrdenadasPorCurso());
	}
