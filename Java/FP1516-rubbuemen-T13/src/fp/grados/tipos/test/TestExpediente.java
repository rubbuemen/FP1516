...
public class TestExpediente {
	...
	private static void testGetNotasOrdenadasPorAsignatura() {
		...
		Nota n1 = new NotaImpl(fp, 2015, Convocatoria.PRIMERA, 3.0, false);
		Nota n2 = new NotaImpl(adda, 2015, Convocatoria.PRIMERA, 4.0, false);
		Nota n3 = new NotaImpl(fp, 2015, Convocatoria.SEGUNDA, 6.0, false);
		Nota n4 = new NotaImpl(adda, 2015, Convocatoria.SEGUNDA, 7.0, false);
		ex.nuevaNota(n1);
		ex.nuevaNota(n2);
		ex.nuevaNota(n3);
		ex.nuevaNota(n4);
		testGetNotasOrdenadasPorAsignatura(ex);
	}
	
	private static void testGetMejorNotaNormal() {
		System.out.println("\n========Probando método getMejorNota======================================================================================");
		Expediente ex = new ExpedienteImpl();
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Asignatura adda = new AsignaturaImpl("Analisis y Diseño de Datos y Algoritmos", "2050010", 12.0, TipoAsignatura.ANUAL, 2);
		Asignatura edc = new AsignaturaImpl("Estructura de computadores", "2050017", 12.0, TipoAsignatura.ANUAL, 1);
		Nota n1 = new NotaImpl(fp, 2015, Convocatoria.PRIMERA, 3.0, false);
		Nota n2 = new NotaImpl(adda, 2015, Convocatoria.PRIMERA, 7.0, false);
		Nota n3 = new NotaImpl(fp, 2015, Convocatoria.SEGUNDA, 6.0, false);
		Nota n4 = new NotaImpl(adda, 2015, Convocatoria.SEGUNDA, 7.0, false);
		Nota n5 = new NotaImpl(adda, 2014, Convocatoria.PRIMERA, 10.0, true);
		Nota n6 = new NotaImpl(edc, 2015, Convocatoria.PRIMERA, 10.0, true);
		ex.nuevaNota(n1);
		ex.nuevaNota(n2);
		ex.nuevaNota(n3);
		ex.nuevaNota(n4);
	...
	private static void testGetMejorNotaExcepcion() {
		System.out.println("\n========Probando método getMejorNota con un expediente vacio======================================================================================");
		Expediente ex = new ExpedienteImpl();
		testGetMejorNota(ex);
	}
	...
	private static void testGetNotasOrdenadasPorAsignatura(Expediente ex) {
		System.out.println("Las notas del expediente ordenadas por asignatura son: " + ex.getNotasOrdenadasPorAsignatura());
	}
	
	private static void testGetMejorNota(Expediente ex) {
		try{
			System.out.println("Las notas del expediente son: " + ex.getNotas());
			System.out.println("La mejor nota del expediente es: " + ex.getMejorNota());
