...
public class TestProfesor {
	public static void main(String[] args) {
		...
		testImparteAsignatura1MapNormal();
		testImparteAsignatura1MapExcepcion1();
		testImparteAsignatura1MapExcepcion2();
		testImparteAsignatura1MapExcepcion3();
		testImparteAsignatura1MapExcepcion4();
		testImparteAsignatura1MapExcepcion5();
		
		testImparteAsignatura2MapNormal();
		testImparteAsignatura2MapExcepcion1();
		testImparteAsignatura2MapExcepcion2();
		testImparteAsignatura2MapExcepcion3();
		testImparteAsignatura2MapExcepcion4();
		testImparteAsignatura2MapExcepcion5();
		
		testDedicacionAsignaturaMap();
		
		testEliminaAsignaturaMap();
	}
	...
	private static void testImparteAsignatura1MapNormal() {
	...
	private static void testImparteAsignatura1MapExcepcion1() {
	...
	private static void testImparteAsignatura1MapExcepcion2() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de nuevaAsignatura, excediendo el número de créditos de la asignatura======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Profesor pr = new ProfesorImpl2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@.us.es", Categoria.TITULAR);
		lsi.nuevaAsignatura(fp);
	...
	private static void testImparteAsignatura1MapExcepcion3() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de nuevaAsignatura, número de créditos igual a 0======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Profesor pr = new ProfesorImpl2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@.us.es", Categoria.TITULAR);
		lsi.nuevaAsignatura(fp);
	...
	private static void testImparteAsignatura1MapExcepcion4() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de nuevaAsignatura, con un profesor (que no es tipo ayudante) que imparte más creditos de los permitidos======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Asignatura adda = new AsignaturaImpl("Analisis y Diseño de Datos y Algoritmos", "2050010", 12.0, TipoAsignatura.ANUAL, 2);
		Asignatura ir = new AsignaturaImpl("Ingeniería de Requisitos", "2050020", 9.0, TipoAsignatura.PRIMER_CUATRIMESTRE, 3);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
	...
	private static void testImparteAsignatura1MapExcepcion5() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de nuevaAsignatura, con un profesor de tipo 'ayudante' que imparte más creditos de los permitidos======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 3.0, TipoAsignatura.ANUAL, 1);
		Asignatura adda = new AsignaturaImpl("Analisis y Diseño de Datos y Algoritmos", "2050010", 5.0, TipoAsignatura.ANUAL, 2);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
	...
	private static void testImparteAsignatura2MapNormal() {
	...
	private static void testImparteAsignatura2MapExcepcion1() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de actualizaDedicacion, actualizando la asignatura de manera que no es del departamento del profesor======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Departamento isa = new DepartamentoImpl("Ingeniería de sistemas y automática");
		Profesor pr = new ProfesorImpl2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@.us.es", Categoria.TITULAR);		
	...
	private static void testImparteAsignatura2MapExcepcion2() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de actualizaDedicacion, excediendo el número de créditos de la asignatura======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Profesor pr = new ProfesorImpl2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@.us.es", Categoria.TITULAR);
		lsi.nuevaAsignatura(fp);
	...
	private static void testImparteAsignatura2MapExcepcion3() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de actualizaDedicacion, número de créditos igual a 0======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 12.0, TipoAsignatura.ANUAL, 1);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Profesor pr = new ProfesorImpl2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@.us.es", Categoria.TITULAR);
		lsi.nuevaAsignatura(fp);
	...
	private static void testImparteAsignatura2MapExcepcion4() {
		System.out.println("\n========Probando el método imparteAsignatura con map en el caso de actualizaDedicacion, con un profesor (que no es tipo ayudante) que imparte más creditos de los permitidos======================================================================================");
		Asignatura fp = new AsignaturaImpl("Fundamentos de Programacion", "2050001", 30.0, TipoAsignatura.ANUAL, 1);
		Asignatura adda = new AsignaturaImpl("Analisis y Diseño de Datos y Algoritmos", "2050010", 12.0, TipoAsignatura.ANUAL, 2);
		Departamento lsi = new DepartamentoImpl("Lenguajes y Sistemas Informáticos");
		Profesor pr = new ProfesorImpl2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@.us.es", Categoria.TITULAR);		
	...
	private static void testImparteAsignatura2MapExcepcion5() {
	...
	private static void testDedicacionAsignaturaMap() {
	...
	private static void testEliminaAsignaturaMap() {
